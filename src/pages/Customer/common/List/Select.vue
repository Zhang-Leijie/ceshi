<template>
  <div>
        ...
        <el-table-column type="expand">
          <template scope="props">
            <el-form label-position="left" inline>
              <el-form-item label="委托补充：">
                <span>{{ props.row.additional }}</span>
              </el-form-item>
              <el-form-item label="已推送：">
                <span>{{ props.row.is_push == 1?"已推送":"未推送" }}</span>
              </el-form-item>
              <el-form-item label="收到报价：">
                <span>{{ `${props.row.quotes}个`}}</span>
              </el-form-item>
              <el-form-item label="推送报价：">
                <span>{{ `${props.row.push_quotes}个`}}</span>
              </el-form-item>
            </el-form>
          </template>
        </el-table-column>
        <el-table-column label="订单编号" prop="id" width="80" show-overflow-tooltip>
        </el-table-column>
    ...
    <div class="table-bg" v-show="type == 2">
      <el-table :data="list" v-loading.body="loading2" style="width: 100%" class="dealList" >
        <el-table-column type="expand">
          <template scope="props">
            <el-form label-position="left" inline>
              <el-form-item label="委托补充：">
        ...
        <el-table-column label="订单编号" prop="id" width="100" show-overflow-tooltip>
        </el-table-column>
    ...
    <div class="bottom-pagination">
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="page" :page-sizes="[10, 20, 30, 40,50,100]"
