  ...
  <div>
    ...
    <div class="table-bg" v-show="type == 1">
      <el-table :data="list" style="width: 100%" v-loading.body="loading" class="dealList">
          ...
          <template scope="props">
            <el-form label-position="left" inline>
              ...
              <el-form-item label="完成时间：">
                <span>{{dateFormat(props.row.last_progress)}}</span>
              </el-form-item>
            </el-form>
          </template>
        </el-table-column>
        ...
        <el-table-column label="">
          <template scope="scope">
            <el-button type="primary" size="mini" @click="startDealing(data.order.id)">进行处理</el-button>
            <el-button type="danger" size="mini" @click="onCancel(data.order.id)">取消处理</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
    <div class="table-bg" v-show="type == 2">
      <el-table :data="list" style="width: 100%">
        ...
        <el-table-column label="">
          <template scope="scope">
            <el-button type="primary" size="mini" @click="waitDealing(data.order.id)">开始处理</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
